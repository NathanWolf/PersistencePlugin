...
{
    BOOLEAN, BYTE, DATE, DOUBLE, ENUMERATION, FLOAT, INTEGER, LIST, LONG, NULL, OBJECT, STRING;
    ...
    public static Object convertValue(Object value, Class<?> targetClass)
    {
        ...
        // Handle dates- converting to int for now, should be encapsulated in a
        // DataStore-specific way, but
    ...
    public static DataType getTypeFromClass(Class<?> fieldType)
    {
        ...
        {
            // Don't get the PersistedClass here, or you might cause recursion
     ...
     * 
     * TODO: Move this to a SqlData type class, allow stores to override type
     * conversion
     * 
     * @param sqlType
     *            The java.sql.Type value to convert
    ...
    public static boolean isPrimitive(Class<?> targetClass)
    {
        ...
        return boolean.class.isAssignableFrom(targetClass) || float.class.isAssignableFrom(targetClass) || int.class.isAssignableFrom(targetClass) || byte.class.isAssignableFrom(targetClass) || long.class.isAssignableFrom(targetClass) || double.class.isAssignableFrom(targetClass);
    }
